...
def forecasted_plot(request):
    ...
    cont = {
            # "query_results":query_results,
            'forecasted_Load':l,
            'rmseSMA'  :round(np.sqrt(((np.array(l[1][1:length]) - np.array(l[8][1:length]))**2).mean()),2),
            'rmseWMA'  :round(np.sqrt(((np.array(l[2][1:length]) - np.array(l[8][1:length]))**2).mean()),2),
            'rmseSES'  :round(np.sqrt(((np.array(l[3][1:length]) - np.array(l[8][1:length]))**2).mean()),2),
            'rmseARIMA':round(np.sqrt(((np.array(l[4][1:length]) - np.array(l[8][1:length]))**2).mean()),2),
            'rmseLSTM' :round(np.sqrt(((np.array(l[5][1:length]) - np.array(l[8][1:length]))**2).mean()),2),
            'rmseGRU'  :round(np.sqrt(((np.array(l[6][1:length]) - np.array(l[8][1:length]))**2).mean()),2),
            'rmseRNN'  :round(np.sqrt(((np.array(l[7][1:length]) - np.array(l[8][1:length]))**2).mean()),2),
